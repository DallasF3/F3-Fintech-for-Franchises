...
router.post('/salesforce/connect', authenticateToken, integrationController.connectSalesforce);
...
router.get('/salesforce/callback', integrationController.salesforceCallback);
