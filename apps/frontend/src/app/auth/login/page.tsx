        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-6">
            ...
            <div>
              ...
              />
              {fieldError.email && (
                <p className="text-[12px] font-medium text-red-600 mt-1.5">{fieldError.email}</p>
              )}
            </div>

            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-[13px] font-bold text-neutral-800 uppercase tracking-wider">
                  Password
                </label>
                <Link
                  href="/auth/forgot-password"
                  className="text-[12px] font-bold text-[#ff385c] hover:text-[#e00b41] transition-colors"
                >
                  Forgot?
                </Link>
              </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-[13px] font-semibold">
              <span className="px-3 bg-white text-neutral-400 uppercase tracking-wider">or</span>
            </div>
          </div>
          ...
          <motion.button
            ...
            whileHover={{ scale: googleLoading || loading ? 1 : 1.01 }}
      ...
      <div className="hidden lg:flex w-1/2 bg-neutral-950 p-12 items-center justify-center relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-[32px] font-extrabold leading-[1.1] tracking-[-0.03em] text-white mb-4">
            Turn your franchise data into <span className="text-[#ff385c]">growth</span>
          </h2>
          <p className="text-[16px] leading-[1.6] text-white/60 mb-10">
            Connect your systems in minutes. Get actionable AI insights across all your locations by tomorrow morning.
          </p>
